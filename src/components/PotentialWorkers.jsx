...
const PotentialWorkers = () => {
  ...
  return (
    <section
      ...
      className="bg-[#eef0ff] py-16 font-[Inter,sans-serif]"
    >
      <div className="w-full max-w-[2000px] mx-auto flex flex-col items-center gap-12 px-4">
        <h2
          className={`text-[36px] font-bold text-center w-full bg-gradient-to-r from-[#0f1b66] to-[#5327ff] bg-clip-text text-transparent transition-all duration-700 ease-out ${
        ...
        <div className="flex flex-wrap justify-center gap-60 w-full">
          {STATS.map(({ figure, label }, index) => (
            ...
            >
              <span className="text-[48px] font-black text-[#6b3dff]">{figure}</span>
