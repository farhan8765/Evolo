    ...
    <section className="bg-[#EFF0FF] px-4 py-24">
      <div className="mx-auto flex max-w-6xl flex-col gap-12 lg:flex-row lg:items-center">
        <div className="flex-1 text-center lg:text-left">
          <p className="text-xs uppercase tracking-[0.35em] text-[#827fad]">
            Tagline
          </p>
          <h2 className="mt-4 text-5xl font-bold leading-tight text-[#1b1f3b]">
            <span className="bg-gradient-to-r from-[#000000] to-[#2B1BDD] bg-clip-text text-transparent">
              Explore more about Evolo AI
            </span>
          </h2>
          <p className="mt-6 text-base text-[#4d5060] md:text-lg">
