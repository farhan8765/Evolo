    ...
    <div className="w-full bg-[#EFF0FF] py-10 md:py-20 px-4 sm:px-6 font-['Raleway']">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-16 items-start">
        ...
        <div>
          ...
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold leading-tight bg-gradient-to-r from-black to-[#2B1BDD] bg-clip-text text-transparent">
        ...
        <div className="text-gray-600 text-sm sm:text-[15px] leading-relaxed">
          ...
          <p>
          We don't just build software, we build systems that work for students, staff, and institutions.
          </p>
        </div>
