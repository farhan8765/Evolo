...
const CertifiedHealthWorkersCompliance = () => {
  return (
    <section className=" px-4 py-16 text-center sm:px-6 lg:py-24">
      <div className="mx-auto w-full max-w-6xl">
        ...
        <p className="mx-auto mt-8 max-w-[980px] font-['Raleway'] text-[17px] font-medium leading-8 text-[#69717E] sm:text-[19px]">
          FERPA, HIPAA &amp; CYBHI compliant. Audio via Whisper (self-hosted),
          never reaching third-party servers. PII auto-redacted. Data in
          encrypted MongoDB Atlas, secure VPC.
        </p>
...
export default CertifiedHealthWorkersCompliance;
