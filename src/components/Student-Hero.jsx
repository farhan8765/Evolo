...
const StudentHero = () => {
  ...
  return (
    <section className="relative overflow-hidden text-white pt-24">
      <div className="absolute -right-24 top-0 h-[520px] w-[520px] rounded-full bg-gradient-to-br" />
      <div className="relative z-10 mx-auto flex max-w-7xl flex-col items-center gap-12 px-6 py-20 lg:flex-row lg:items-center lg:gap-16">
        <div className="flex-1 text-center lg:text-left">
          <p className="text-xs font-semibold uppercase tracking-[0.25em] text-[#7f84a9]">
            Tagline
          </p>
          ...
          <div className="mt-10 flex flex-wrap items-center justify-center gap-4 lg:justify-start">
            {storeBadges.map((badge) => (
              <img
                ...
                src={badge.src}
                alt={badge.alt}
                className="h-20 w-auto rounded-[18px] p-2"
              />
            ))}
          </div>
        </div>
        ...
        <div className="relative flex-1">
          <div className="absolute inset-0 -right-8 top-6 h-full w-full rounded-full blur-2xl" />
          <img
