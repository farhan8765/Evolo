    ...
    <section className="relative overflow-hidden text-white pt-24">
      ...
      <div className="relative z-10 mx-auto flex max-w-7xl flex-col items-center gap-12 px-6 py-20 lg:flex-row lg:items-center lg:gap-16">
        <div className="flex-1 text-center lg:text-left">
          ...
          <div
            className="mt-10 flex flex-wrap items-center justify-center gap-4 lg:justify-start animate-hero-reveal"
          ...
          >
            {storeBadges.map((badge) => (
              <img
                ...
                src={badge.src}
                alt={badge.alt}
                className="h-20 w-auto rounded-[18px] p-2 transition-transform duration-500 hover:-translate-y-1"
              />
            ))}
          </div>
        </div>

        <div className="relative flex-1 animate-hero-reveal" style={{ animationDelay: "0.45s" }}>
