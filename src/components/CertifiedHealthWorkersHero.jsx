...
const CertifiedHealthWorkersHero = () => {
  return (
    <section className="relative isolate overflow-hidden px-4 pb-16 pt-14 text-white sm:px-6 sm:pb-20 sm:pt-[72px] lg:pb-24 lg:pt-24">
      <div className="mx-auto grid w-full max-w-6xl items-center gap-12 lg:grid-cols-[0.95fr_1.05fr] lg:gap-16">
        <div className="max-w-2xl text-center lg:text-left">
          ...
          <p className="mt-7 max-w-[620px] font-['Raleway'] text-[17px] font-medium leading-8 text-[#5F6F78] sm:text-[20px] lg:mx-0">
            Authorized staff who both report incidents and deliver follow-up
            coaching sessions.
          </p>
        </div>
        ...
        <div className="relative mx-auto flex min-h-[420px] w-full max-w-[570px] items-center justify-center sm:min-h-[520px] lg:min-h-[560px]">
          <img
            src="/images/chw1.png"
            alt="Certified health worker dashboard and coaching session previews"
            width={568}
            height={576}
...
export default CertifiedHealthWorkersHero;
