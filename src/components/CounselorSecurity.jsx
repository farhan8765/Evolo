...
const CounselorSecurity = () => {
  return (
    <section className="px-4 py-10 md:py-14">
      <div className="mx-auto w-full max-w-6xl">
        <div className="mx-auto flex max-w-4xl flex-col items-center text-center">
          <p className="m-0 font-['Raleway'] text-[13px] font-medium leading-[20px] text-[#11131F]">
            Discover Talent
          </p>
          <h2 className="mt-2 m-0 w-full max-w-[700px] bg-[linear-gradient(90deg,_#000000_0%,_#2B1BDD_100%)] bg-clip-text text-center font-['Raleway'] text-[28px] font-bold leading-[100%] tracking-[0.5%] text-transparent sm:text-[36px] md:text-[48px]">
        ...
        <div className="mx-auto mt-8 grid max-w-4xl gap-3 sm:grid-cols-2 lg:grid-cols-4">
          {complianceItems.map((item) => (
            <article
              key={item}
              className="flex min-h-[86px] items-center justify-center rounded-[12px] border border-[#DADDF0] px-4 text-center shadow-[0_3px_8px_rgba(0,0,0,0.08)]"
            >
